import 'package:sixfeet/visao/tela/Apoio.dart';
import 'package:sixfeet/visao/tela/Contato.dart';
import 'package:sixfeet/visao/tela/ItemMenu.dart';
import 'package:sixfeet/visao/tela/Sobre.dart';
import 'dart:io';
    ...
    return Scaffold(
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'DISPOSITIVOS PROXIMOS: ${_listDevice.length.toString()}',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                ),
      ...
      drawer: Drawer(
        ...
        child: ListView(children: <Widget>[
          ...
          ItemMenu(
              Icons.phone_in_talk,
              'Apoio de Tratamento do covid-19',
              () => {
          ...
          ItemMenu(
              ...
              () => {
                    Navigator.of(context)
                        .push(MaterialPageRoute(builder: (context) => Apoio()))
                  }),
          ItemMenu(
              Icons.error,
              'Sobre',
          ...
          ItemMenu(Icons.close, 'Sair', () => {exit(0)}),
        ]),
      ),
    );
  }
